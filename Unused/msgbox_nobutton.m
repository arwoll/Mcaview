function varargout=msgbox_nobutton(varargin)
%MSGBOX_NOBUTTON Message box without the 'OK' button.
%  AW made this for mcaview -- March 2006 -- to display wait messages when
%  loading large data files.  In this case, I don't want the user to
%  dismiss the box -- it is automatically dismissed when the opearation is
%  complete.
%
...
%  $Revision: 1.57.4.9 $ $Date: 2005/06/09 04:41:10 $
...
% The following width, height values set to 0 by AW, March 06
OKWidth=1;
OKHeight=1;
