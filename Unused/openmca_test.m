...
if any(strcmp(mcaformat, {'', 'chess1', 'chess3','chess_sp', 'bessy_xml'}))
...
switch mcaformat
    ...
    case {'chess1', 'chess3', 'chess_sp'}
        ...
        tic;
        h = msgbox_nobutton('Loading MCA data, please wait...(patiently)', 'Open', 'warn');
...
if scandata.spec.complete ~= 1
    ...
    elseif spectra < scandata.spec.npts
        fprintf('This should not happen -- implies a few spectra than spec pts written\n')
